        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((authorize) -> {
                    authorize.requestMatchers(SecurityConstants.AUTH_REGISTER_URL, SecurityConstants.AUTH_LOGIN_URL, SecurityConstants.AUTH_VERIFY_EMAIL_URL, SecurityConstants.AUTH_RESET_PASSWORD, SecurityConstants.AUTH_FORGOT_PASSWORD).permitAll()
                            ...
                            .requestMatchers(SecurityConstants.ADMIN_PROFILE_UPDATE_STATUS_URL).hasAnyAuthority(SecurityConstants.ROLE_ADMIN_DO, SecurityConstants.ROLE_ADMIN_TIENDA, SecurityConstants.ROLE_ADMIN)
                            ...
                            .requestMatchers(SecurityConstants.ADMINS_BULK_JEFES).hasAnyAuthority(SecurityConstants.ROLE_ADMIN_DO, SecurityConstants.ROLE_ADMIN_TIENDA, SecurityConstants.ROLE_ADMIN)
                            .requestMatchers(SecurityConstants.USERS_GET).hasAnyAuthority(SecurityConstants.ROLE_ADMIN_DO, SecurityConstants.ROLE_ADMIN_TIENDA, SecurityConstants.ROLE_ADMIN)
                            ...
                            .requestMatchers(SecurityConstants.USERS_BY_CURSO).hasAnyAuthority(SecurityConstants.ROLE_ADMIN_TIENDA, SecurityConstants.ROLE_ADMIN_DO, SecurityConstants.ROLE_ADMIN)
